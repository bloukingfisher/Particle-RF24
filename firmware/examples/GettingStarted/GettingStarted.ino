...
#include "particle-rf24.h" //when using the WEB IDE add this line if not automatically added by the IDE
//#include "particle-rf24/particle-rf24.h" //Original reference
